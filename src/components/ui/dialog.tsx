...
/**
 * DialogContent
 * fullscreen: when true, renders a full-viewport overlay variant instead of centered modal
 */
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          fullscreen
            ? "fixed inset-0 z-[999] w-[100vw] h-[100svh] max-w-none rounded-none border-0 p-0 shadow-none bg-background"
